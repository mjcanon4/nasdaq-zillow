...
# df.to_csv('77007.csv', index=False, sep=',')

# use_cols = df.columns

# read_77007 = pd.read_csv(
#     '77007.csv', index_col="date", usecols=use_cols)
...
for zip in houston_zip:
    ...
    pd.read_csv('77007.csv', index_col="date", usecols=use_cols)
